...
################################################################################
## Form generated from reading UI file 'item_inventorysRqpwqk.ui'
##
...
"}")
        ...
        self.gridLayout.addWidget(self.itemAmount, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.itemquant, 3, 3, 1, 1)
