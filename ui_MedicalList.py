...
################################################################################
## Form generated from reading UI file 'MedicalListflWrLv.ui'
##
...
"}")
        ...
        icon = QIcon()
        icon.addFile(u":/icons/create_new_64px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/view_file_64px.png", QSize(), QIcon.Normal, QIcon.Off)
