...
################################################################################
## Form generated from reading UI file 'ordnance2mhxSdO.ui'
##
...
"}\n"
"#name, #lineEdit_2, #lineEdit_3, #lineEdit_4, #lineEdit_5, #lineEdit_6, #lineEdit_7, #lineEdit_8, #lineEdit_9, #lineEdit_10, #lineEdit_11{\n"
"	border: none;\n"
...
"}")
        ...
        icon = QIcon()
        icon.addFile(u":/logo/save_100px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/logo/print_24px.png", QSize(), QIcon.Normal, QIcon.Off)
